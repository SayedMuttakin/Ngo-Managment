...
import { User, Phone, Calendar, CreditCard, MapPin, Edit, Trash2, UserCheck, History } from 'lucide-react';
...
const MemberCard = ({ member, onEdit, onDelete, onViewProfile }) => {
  ...
  const handleLoanHistory = () => {
    // Navigate to member profile page which shows loan history
          ...
          <div className="relative flex-shrink-0">
            {member.profileImage ? (
              <img
                ...
                onError={(e) => {
                  console.error('Failed to load image:', member.profileImage);
            ...
            <div
              className={`bg-white rounded-lg ${member.profileImage ? 'hidden' : 'flex'} items-center justify-center shadow-lg`}
